...
def get_Drunk_Step(dkId, i): # Get dkId for drunk's ith steps. In this way, dkId goes from 0 to 24, which is，(0,1,2,3...)
	if i < len(drunkRoutes[dkId]): 
        ...
        # For example: Some drunks might walk 20steps back home and some might needs 50 steps. It needs to refresh at the most steps drunks walked. If using 20 steps to refresh, the drunks need 50 steps home can't make it to their home. 
...
menu_bar = tk.Menu(root)   #Sets the menue bar.
